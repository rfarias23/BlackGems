        ...
        <main className="bg-midnight-ink text-slate-100 min-h-screen">
            ...
            <section className="pt-16 pb-20 px-6 md:pt-20 md:pb-24 md:px-12 lg:pt-[80px] lg:pb-[120px] lg:px-[120px]">
                <div className="max-w-[700px] mx-auto">
                    <h1 className="font-display text-[28px] md:text-[34px] lg:text-[40px] leading-[1.15] font-normal text-slate-100 mb-6">Security</h1>
                    <p className="text-base text-slate-400 leading-relaxed">
                        BlackGem is built with institutional-grade security. SOC 2 certification is in progress. For security inquiries, contact us at{' '}
